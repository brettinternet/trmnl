...
Shows a year of daily snowfall as a quiet e-ink chart: the previous 365 days are drawn as a dark line, while today and the next seven strictly future days sit in a shaded, dashed forecast zone. The large value is the accumulated snowfall over the previous 365 days; the smaller value counts snowy days with at least 1 cm (0.4 in), and the chart labels the snowiest day in each third of the year.
